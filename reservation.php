...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
                    ...
                    if (isset($_GET['room_id'])){?>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group col-lg-6">
                                    <label>Available Rooms & Room No</label>
                    ...
                    <?php } else{?>
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-lg-12">
                                    <h4 style="font-weight: bold">Total Days : <span id="staying_day">0</span> Days</h4>
                                    <h4 style="font-weight: bold">Price: Rs. <span id="price">0</span> /-</h4>
                                    <h4 style="font-weight: bold">Total Amount : Rs. <span id="total_price">0</span> /-</h4>
                                </div>
                            </div>
                        </div>
                    <?php }
    ...
    <div class="row">
        <div class="col-sm-12">
            <p class="back-link">LAWRENCE HILL PARADISE</p>
        </div>
    </div>
